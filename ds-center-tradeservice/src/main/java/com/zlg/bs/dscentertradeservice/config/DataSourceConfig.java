package com.zlg.bs.dscentertradeservice.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.edas.acm.ConfigService;
import com.alibaba.fastjson.JSONObject;
import com.zlg.bs.dscentertradeservice.config.bean.DataSourceVo;
...
@Configuration
@MapperScan(basePackages = {"com.zlg.bs.dscentertradeservice.mapper"},sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
    @Bean(name = "datasource",destroyMethod = "close")
    public DruidDataSource dataSource() throws Exception{
        String config = ConfigService.getConfig("ds.zlg.trade.datasourcevo", "zlg", 3000);
